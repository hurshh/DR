...
class SightDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final headerColor = Color(0xFF58D3CA);
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 10),
                        const Text(
                          'Your eyes are like cameras! They capture light and send pictures to your brain. You can see colors, shapes, and movement because of your amazing eyes!',
                          style: TextStyle(
                            fontSize: 18,
                            height: 1.45,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: const [
                              ...
                              SizedBox(height: 6),
                              Text(
                                'You blink about 15,000 times every day!',
                                style: TextStyle(
                                  fontSize: 16,
                                  fontWeight: FontWeight.w600,
                                  color: Colors.black87,
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () => Navigator.pushReplacementNamed(
                                context, Routes.learnSightStep1),
                            child: const Text(
                              'Start Learning →',
                              style: TextStyle(
                                fontSize: 18,
