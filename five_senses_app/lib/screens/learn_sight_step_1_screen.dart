...
class LearnSightStep1Screen extends StatelessWidget {
  const LearnSightStep1Screen({super.key});
              ...
              child: Column(
                ...
                children: [
                  ...
                  _HowStep(
                    index: 3,
                    text:
                        'The retina sends signals to your brain!',
                  ),
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed: () =>
                    Navigator.pushReplacementNamed(context, Routes.learnSightStep2),
                child: const Text(
                  'Next Step →',
                  style: TextStyle(
                    fontSize: 18,
