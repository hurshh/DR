...
const List<_FoodItem> _foods = [
  _FoodItem(
    name: 'Lemon', emoji: '🍋', correctTaste: 'Sour', cardBg: Color(0xFFFFFDE7),
    funFact: 'Lemon is one of the SOUREST fruits on Earth!',
  ),
  _FoodItem(
    name: 'Strawberry', emoji: '🍓', correctTaste: 'Sweet', cardBg: Color(0xFFFFEBEE),
    funFact: 'Strawberries are packed with natural sugar — that\'s why they\'re SWEET!',
  ),
  _FoodItem(
    name: 'Chips', emoji: '🍟', correctTaste: 'Salty', cardBg: Color(0xFFFFF8E1),
...
class TasteClassifierQuestion1Screen extends StatefulWidget {
  const TasteClassifierQuestion1Screen({super.key});

  @override
  State<TasteClassifierQuestion1Screen> createState() =>
      _TasteClassifierQuestion1ScreenState();
}

class _TasteClassifierQuestion1ScreenState
    extends State<TasteClassifierQuestion1Screen> {
  ...
  void initState() {
    ...
    Future.delayed(const Duration(milliseconds: 400), () {
      AudioService.instance.speak(
        'Taste Classifier! Round 1 of 4. Look at each food and pick its taste. You have 5 lives. Let\'s start!',
      );
    });
  }
  ...
  void _onNext() {
    if (_lives <= 0 || _currentIndex >= _foods.length - 1) {
      Navigator.pushReplacementNamed(
        context,
        Routes.tasteClassifierQuestion2,
        arguments: GameCarry(
          scoreSoFar: _score,
          correctSoFar: _score ~/ 200,
          totalSoFar: _foods.length,
  ...
  Widget _buildFoodCard(_FoodItem food, bool isTablet) {
    return Container(
      ...
      padding: EdgeInsets.symmetric(
          vertical: isTablet ? 28 : 20, horizontal: 16),
      decoration: BoxDecoration(
        color: food.cardBg,
      ...
      child: Column(
        ...
        children: [
          Text(food.emoji,
              style: TextStyle(fontSize: isTablet ? 70 : 56)),
            ...
            children: [
              AnimatedContainer(
                ...
                child: Column(
                  ...
                  children: [
                    Text(taste.emoji,
                        style: TextStyle(fontSize: isTablet ? 28.0 : 26.0)),
  ...
  Widget _buildNextButton(bool isTablet) {
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child: Text(
          isLast ? 'Round 2 →' : 'Next Food →',
          style: TextStyle(
              fontSize: isTablet ? 20 : 18, fontWeight: FontWeight.w900),
        ),
      ),
    );
  }
